> 译： [How I Use Every Claude Code Feature](https://blog.sshh.io/p/how-i-use-every-claude-code-feature)
...
常常配合 `--dangerously-skip-permissions` 来随心所欲地写代码。在工作中，我所在团队的一部分负责为工程团队构建AIIDE规则和工具，仅仅是代码生成就会消耗每月**数十亿个**token。
...
从基础的 `CLAUDE.md` 文件和自定义斜杠命令，到 `Subagents`、`Hooks`、`GitHub Actions`等强大能力。**这篇文章篇幅较长，我更建议把它当作参考手册，而不是一次性读完。**
...
*如果您正在寻找更多关于为编码助手编写 Markdown 的技巧，请参阅 [“AI 无法读懂你的文档”](https://blog.sshh.io/p/ai-cant-read-your-docs)[、“AI 驱动的软件工程”](https://blog.sshh.io/p/ai-powered-software-engineering),以及 [“Cursor（AI IDE）的工作原理”](https://blog.sshh.io/p/how-cursor-ai-ide-works).*
...
![50bf8b3b26bc8aee1a536a6557742dcd01ae545e_2_690x429](./50bf8b3b26bc8aee1a536a6557742dcd01ae545e_2_690x429.jpeg)

*这是我最近一个个人项目中 **/context** 的截图。你可以把它想象成磁盘空间，随着你开发一个功能，它会逐渐被填满。几分钟或几小时后，你就需要清除消息（紫色部分）来腾出空间继续工作。*



![06ed452cd89bcbe760c9889acb59a9d0dcbbd2dd_2_690x296](./06ed452cd89bcbe760c9889acb59a9d0dcbbd2dd_2_690x296.png)
...
> **核心要点：**
>
> GHA 是将 Claude Code 投入生产运营的终极方式。它将其从个人工具转变为你工程系统中一个核心的、可审计的、自我改进的部分。拥有无限自由的可能性![:thinking:](https://linux.do/images/emoji/twemoji/thinking.png?v=15)
...
内容很多，但希望对你有用。如果你还没有开始使用像 `Claude Code` 或 `Codex CLI` 这样的基于命令行的 Code Agent，你或许应该开始了。这些高级功能很少有好的指南，所以学习的唯一方法就是亲身投入进去。